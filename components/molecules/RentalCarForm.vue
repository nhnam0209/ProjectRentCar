  ...
  <div class="">
    <div class="py-10" :class="{ 'modal-close': isActive || isActiveReturn }">
      <div class="w-full flex items-center justify-center my-10">
        <div
          class="w-1/2 flex items-center justify-between shadow border border-solid rounded-xl overflow-hidden border-black text-center"
        >
          <div
      ...
      <div class="w-full flex items-center justify-center">
        <div class="bg-white w-1/2 p-4 rounded-lg shadow">
          <div class="m-4">
          ...
          <div class="m-4">
            ...
            <div class="grid grid-cols-2">
              <div class="">
                ...
                >
                <div class="">
                  <input type="range" min="0" step="1" max="75" value="5" />
                  <span class="ml-2 slide-value">5%</span>
                </div>
              </div>
              <div class="">
                <span class="text-lg"
                ...
                <div class="">
                  ...
                  <span class="ml-2 slide-value">10%</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-2">
              <div class="">
                ...
                <div class="">
                  ...
                  <span class="ml-2 slide-value">7km</span>
                </div>
              </div>
              <div class="">
              ...
              <div class="">
                ...
                <div class="">
                  ...
                  <span class="ml-2 slide-value">0km</span>
                </div>
              </div>
            </div>
          </div>
