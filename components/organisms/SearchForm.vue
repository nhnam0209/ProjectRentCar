    ...
    <form action="" class="booking-form">
            ...
            <div class="dateime-pickup-car inline-block">
              <div class="station-input-pickup w-full">
                ...
                <div class="pickup-input flex ">
                  ...
                  <RInput typeInput="text" class="label-input" placeholderInput="Pick up & Return location"/>
                </div>
              </div>

              <div class="input-datetime-pickup-and-return flex justify-between items-center">
                <div class="station-input-pickup w-full">
                  <div class="title-pickup-input py-2">
                  ...
                  <div class="pickup-input flex justify-center">
                    ...
                    <div class="input-date flex justify-center items-center">
                      <RInput typeInput="text" class="label-input label-input-date partition w-full" placeholderInput="Return date"/>
                    </div>
                ...
                <div class="station-input-pickup w-full">
                  ...
                  <div class="pickup-input flex justify-center">
                    ...
                    <div class="input-date flex justify-center items-center">
                      <RInput typeInput="text" class="label-input label-input-date partition" placeholderInput="Return date"/>
                    </div>
                    <div class="input-time flex justify-center items-center">
                      <RInput typeInput="text" class="label-input label-input-time" placeholderInput="Time"/>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="info-hire-car my-4">
        <div class="dateime-pickup-car inline-block">
          ...
          <div
            class="input-datetime-pickup-and-return flex justify-between items-center"
          >
            <div class="station-input-pickup w-full">
              <div class="title-pickup-input py-2">
                <span class="font-bold text-lg">Pick up date & time</span>
              ...
              <div class="pickup-input flex justify-center">
                ...
                <!-- <div class="input-time flex justify-center items-center">
                      <RInput typeInput="text" class=" label-input label-input-time w-full" placeholder="Time">
                    </div> -->
              </div>
            </div>
