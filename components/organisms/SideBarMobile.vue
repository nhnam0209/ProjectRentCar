<template>
  <nav class="h-16 flex justify-between overflow-hidden items-center">
    ...
    <div class="p-4 cursor-pointer icon-hover relative right-0 z-30" @click=" handleMouseEnter()">
      <IconBar class="w-6 h-6" />
    </div>
    <div v-if="isHover" class="bg-gray-600/50 fixed top-0 w-screen h-screen z-40">
      <div
      ...
      <div class="" @click="handleMouseBlur()">
        ...
        <div class="">
          <div class="my-5">
            ...
            <div v-if="!isAdmin" class="flex flex-col border-t border-gray-500 my-2 py-2">
              <NuxtLink
            ...
            <div v-else class="flex-col hidden max-lg:flex border-t border-gray-500 my-2 py-2">
              <NuxtLink
